...
`python app.py
`
<br />Note that the Prometheus server will be running on port 9000. You can access the Prometheus dashboard by visiting http://localhost:9000 in your web browser. The dashboard will show you health information about every node.
